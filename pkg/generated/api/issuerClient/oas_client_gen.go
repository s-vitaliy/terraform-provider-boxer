...
func (c *Client) sendDeleteIdentity(ctx context.Context, params DeleteIdentityParams) (res *DeleteIdentityOK, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityInternal(ctx, DeleteIdentityOperation, r); {
...
func (c *Client) sendDeleteProvider(ctx context.Context, params DeleteProviderParams) (res *DeleteProviderOK, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityInternal(ctx, DeleteProviderOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendGetIdentity(ctx context.Context, params GetIdentityParams) (res GetIdentityRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityInternal(ctx, GetIdentityOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendGetPrincipal(ctx context.Context, params GetPrincipalParams) (res GetPrincipalRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityInternal(ctx, GetPrincipalOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendGetProvider(ctx context.Context, params GetProviderParams) (res GetProviderRes, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityInternal(ctx, GetProviderOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendPostIdentity(ctx context.Context, request *ExternalIdentityRegistrationRequest, params PostIdentityParams) (res *PostIdentityOK, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityInternal(ctx, PostIdentityOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendPostPrincipal(ctx context.Context, request jx.Raw, params PostPrincipalParams) (res *PrincipalCreateResponse, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityInternal(ctx, PostPrincipalOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
...
func (c *Client) sendPostProvider(ctx context.Context, request *OidcIdentityProviderRegistration, params PostProviderParams) (res *PostProviderOK, err error) {
...

	{
		...
		var satisfied bitset
		{
			...
			switch err := c.securityInternal(ctx, PostProviderOperation, r); {
			case err == nil: // if NO error
				satisfied[0] |= 1 << 0
			case errors.Is(err, ogenerrors.ErrSkipClientSecurity):
				// Skip this security.
