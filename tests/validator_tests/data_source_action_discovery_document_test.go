...
func TestDataSourceActionDiscoveryDocument_reading(t *testing.T) {
	const resourceAddress = "data.boxer_action_discovery_document.example"
	const templateName = "data_source_action_discovery_document/data_source_action_discovery_document.tmpl.tf"
